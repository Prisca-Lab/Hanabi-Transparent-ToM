...
from hanabiLearningEnvHandlerNoExplanations import HanabiHandler
...
def main():
    ...
    if gameChoice == "ToM_Human":
        HanabiHandler(approachChoice, None, None, gameChoice, decisionTreesModels, hcicModels)
    else:
        HanabiHandler(None, approachChoiceToM1, approachChoiceToM2, gameChoice, decisionTreesModels, hcicModels)
